...
class TestParty(BaseTestCase):
    ...
    def test_posting_a_party(self):
        ...
        self.assertEqual(resp.json['data'][-1]['name'], 'ANC')
    ...
    def test_getting_a_single_party(self):
        ...
        self.assertEqual(response.json['data']['name'],'NASA')
    ...
    def test_editing_a_party(self):
        ...
        self.assertEqual(response.json['data'][1]['name'],'WIPER')
        self.assertEqual(response.status_code, 200)
    ...
    def test_deleting_a_party(self):
        ...
        self.assertEqual(response.json['data'][0]['message'],'Successfully deleted party with ID:{}'.format(int_id))
        self.assertEqual(response.status_code, 200)
